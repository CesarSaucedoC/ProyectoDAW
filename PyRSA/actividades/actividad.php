  ...
  //if( mysqli_num_rows($tablaBD)>0){
      ...
      <script type="text/javascript">
        $(document).ready(function(){
          ...
          $("#editar").load("../inventario/mdlActEq.php")
          $("#agregar").load("../inventario/mdlAgrEq.php")
          $("#grid").DataTable({
      ...
      <h1 align="center">Inventario de Equipos</h1><br/>
        ...
        <thead>
            ...
            $sitio = $registro['sitio'];
                ...
                $('#frmActEq #pyR3').text('$r3').attr('value','$r3');
                $('#frmActEq #pyUbicacion1').text('$subestacion $voltSist $sitio').attr('value','$idUbicacion');
                $('#frmActEq #pyEquipo').text('$equipo').attr('value','$equipo');
                $('#frmActEq #pyContrasena').text('$contrasena').attr('value','$contrasena');
                $('#frmActEq #pyUsuario').text('$usuario').attr('value','$usuario');
                $('#frmActEq #pyAcceso').text('$acceso').attr('value','$acceso');
                $('#frmActEq #pyMarca').text('$marcat').attr('value','$marca');
                $('#frmActEq #pyModelo').text('$modelo').attr('value','$modelo');
                $('#frmActEq #pynSerie').text('$nSerie').attr('value','$nSerie');
                $('#mdlActEq').modal();\">
