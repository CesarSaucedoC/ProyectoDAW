<!-- Modal Agregar Especialidades-->
   <div id="mdlAddEsp" class="modal fade" role="dialog">
      <div class="modal-dialog">

      <!-- Modal content-->
 		<div class="modal-content">
      	<form id="frmAddEspecialidades" >
		      ...
		      <div class="modal-body" >
		        ...
		        <div class="form-group">
		            ...
		            <input type="text" required class="form-control" name="txtClave" id="txtClave" autofocus maxlength="3" >
		        </div>
		        <div class="form-group">
